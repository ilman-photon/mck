...
function WhyFTComponent() {
    ...
    return (
        <>
            <div className="four-oh-four container flex flex-col mx-auto px-0 lg:pt-0">
                ...
                <div className="relative lg:mb-12 mb-6">
                    ...
                    <div className="lg:absolute top-0 left-0 right-0 bottom-0 bg-transparent-left lg:pr-11 lg:pl-6 w-540 flex flex-col justify-center lg:items-end">
