...
function ServiceUnavailableCoumponent() {
    ...
    return (
        <>
            <div className="err-page-503 container flex lg:flex-row  mx-auto lg:mt-36 lg:pl-18 lg:pb-54 pt-6 pl-4 pr-4 lg:pt-0 lg:pr-0">
                <div className="lg:w-9/12 w-full lg:pt-18">
                ...
                <div className="lg:h-502 overflow-hidden bg-logo-right-503"><img src={serviceErrorData?.data[0]?.backgroundImage?.expandedValue.url} alt="oops" id="err-503-img-005"/></div>
            </div>  
        </>
    );
}
