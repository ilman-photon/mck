    ...
    return (
        <>
            <div className="err-page-503 lg:pt-72 lg:mt-169 container flex lg:flex-row  mx-auto lg:pl-18 lg:pb-54 pt-6 pl-4 pr-4 lg:pt-0 lg:pr-0">
                ...
                <h2 className="lg:heading pb-3 text-54 text-gtl-med font-medium text-mckblue" id="err-503-label-001">{DOMPurify.sanitize(serviceErrorData?.data[0]?.title?.value)}</h2>
