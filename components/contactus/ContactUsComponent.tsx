            ...
            <div className="four-oh-four container flex mx-auto px-0">
                ...
                <div className="grid lg:grid-cols-2 lg:gap-4">
                    <div className="overflow-hidden rounded-lg text-mckthingrey border contact-container lg:mb-12 mb-6">
                        <div className="text-mckblue lg:py-3 lg:px-4 p-3 lg:text-lg text-base font-extrabold shade-blue-bg text-sofia-bold">{contactUsData?.data[0]?.contentArea.expandedValue[0].contactInformationHeading.value}</div>
                        <div className="lg:p-6 p-4 contact-body">
                            ...
                            <div className="flex flex-col lg:flex-row lg:pb-3 pb-4">
                                <span className="contact-number font-extrabold lg:text-lg text-base text-mckblue text-sofia-bold lg:mr-3 flex mb-1 lg:mb-0">
                                ...
                                <p className="lg:text-base text-sm font-normal text-mcknormalgrey text-sofia-reg contact-number-desc">{contactUsData?.data[0]?.contentArea.expandedValue[0].phoneTitle.value}</p>
                            </div>
                            <div className="flex flex-col lg:flex-row lg:pb-3 pb-4">
                                <span className="contact-number font-extrabold lg:text-lg text-base text-mckblue text-sofia-bold lg:mr-3 flex mb-1 lg:mb-0">
                                ...
                                <p className="lg:text-base text-sm font-normal text-mcknormalgrey text-sofia-reg contact-number-desc">{contactUsData?.data[0]?.contentArea.expandedValue[0].operationHourValue.value}</p>
                            </div>
                            <div className="flex flex-col lg:flex-row lg:pb-3 pb-4">
                                <span className="contact-number font-extrabold lg:text-lg text-base text-mckblue text-sofia-bold lg:mr-3 flex">
                            ...
                            <div className="flex flex-col lg:flex-row lg:pb-3">
                                <span className="contact-number font-extrabold lg:text-lg text-base lg:mr-3 text-mckblue text-sofia-bold flex mb-1 lg:mb-0">
                                ...
                                <p className="lg:text-base text-sm font-normal text-mcknormalgrey text-sofia-reg contact-number-desc">{contactUsData?.data[0]?.contentArea.expandedValue[0].locationValue.value}</p>
                            </div>
                        </div>
                    </div>
                    <div className="overflow-hidden rounded-lg text-mckthingrey border contact-container lg:mb-12 mb-6">
                        <div className="text-mckblue lg:py-3 lg:px-4 p-3 lg:text-lg text-base font-extrabold shade-blue-bg text-sofia-bold">{contactUsData?.data[0]?.contentArea.expandedValue[0].whatWeCandoHeading.value}</div>
                        <div className="lg:p-6 p-4 contact-body underline lg:text-lg text-base font-normal text-mckblue text-sofia-reg" dangerouslySetInnerHTML={{ __html: contactUsData?.data[0]?.contentArea.expandedValue[0].whatWeCandoDetail.value, }}>
                ...
                <p className="text-sofia-reg text-mcknormalgrey font-normal lg:text-base text-sm lg:pb-12" dangerouslySetInnerHTML={{ __html: contactUsData?.data[0]?.contentArea.expandedValue[0].disclaimer.value, }}></p>
            </div>
        </>
    );
}
