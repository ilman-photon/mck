...
const SignUpComponent: NextPage = () => {
  return (
    <div id="sign-up-form" className="sign-form grid">
      <input
      ...
      <div className="mt-3 bg-mckgreen text-sofia-bold text-base text-center text-mckblue rounded-lg text-uppercase py-3">
        SUBMIT
      </div>
    </div>
  );
