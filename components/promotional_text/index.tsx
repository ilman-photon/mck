function ImageVideoOrTextSection({ sectionData, textAlignment }: any) {
  return (
    <>
      <div
        className={`w-full container lg:pb-6 pb-6 pt-6 lg:px-72 ${textAlignment === 'text-center' && textAlignment} mx-auto`}
        key={sectionData?.contentLink?.id}
      >
        <h3
          // id="promotion-heading"
          className="text-2xl lg:text-5xl text-gtl-med blue-txt lg:mt-6 text-center"  id={sectionData?.title?.value}
        >
