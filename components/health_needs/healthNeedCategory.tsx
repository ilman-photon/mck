          ...
          {healthNeedData &&
            healthNeedData?.map((healthneedsdata: any, index: number) => (
              <li
                ...
                className={`list-none text-sofia-reg text-mckblue text-lg text-center shrink pl-[30px] pr-[30px] pb-[36px] cursor-pointer lg:max-w-[170px] active:lg:max-w-[160px]${
