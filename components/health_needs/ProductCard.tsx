...
const ProductCard = ({ cardData, product, indexs, mainIndex }: any) => {
    ...
    return (
        <div          
            className="swiper-list-item lg:w-[197px] w-[166px] lg:min-h-[420px] min-h-[300px] rounded-lg border border-[#CCD1E3] mr-1 p-4 "
        >
            ...
            <ImageComponent 
                ...
                id={`hn_label_01_${indexs + 1}_${mainIndex + 1}`} className="h-fit mx-auto border-0 lg:max-h-60 max-h-28"
            />
            </div>
            <div
