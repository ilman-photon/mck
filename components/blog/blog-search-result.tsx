    ...
    return (
        <>
            ...
            <div className='container grid grid-cols-3 gap-4 w-full lg:mt-12 lg:px-9 lg:pb-0 p-4 lg:pt-0 mx-auto'>
                {noSearchClick ? <div className='lg:col-span-2 col-start-1 col-end-7'>
                    <div className='w-full lg:pb-11 pb-5'>
                        <h1 className='lg:text-32 text-32 text-gtl-med text-mckblue lg:pb-6 text-left' id='sr-label-001' >18 results found for “CoverMyMeds”</h1>
                        <div className="text-lg text-sofia-reg text-mckback font-normal lg:pb-px pb-3" id="sr-label-002">Showing results for <strong className='text-mckblue'><i>{noSearchResult}</i></strong></div>
