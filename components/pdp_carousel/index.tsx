...
function PdpCarousel(prodViewData: any) {
  ...
  const { data } = router.query;
    ...
    useEffect(() => {
     ...
     return (
        <div className="flex mx-auto h-[636px]">
            <div className="flex mx-auto flex-col-reverse lg:flex-row pdp-carousel">
                ...
                <div onClick={handleUpArrowClick} className="carousel-prev -left-6 cursor-pointer lg:hidden flex items-center">
            ...
            <div onClick={handleDownArrowClick} className="carousel-next -right-6 lg:hidden cursor-pointer flex items-center">
               ...
               <div className="w-[526px] box-border flex flex-row justify-center items-center p-2 bg-white rounded border border-solid border-mckblue ml-14">
