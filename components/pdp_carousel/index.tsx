            ...
            <div className="flex flex-col-reverse lg:flex-row pdp-carousel w-full">
                <div className="pdp_images flex lg:grid relative">
                    ...
                    <div onClick={handleUpArrowClick} className={`carousel-prev -left-6 cursor-pointer lg:hidden flex items-center absolute left-[-10px] top-[27px] ${arrowClick === 0 ? 'opacity-25' : ''}`}>
                        <svg className="focus:outline-none" width="24" height="49" viewBox="0 0 48 49"  id="hcp-btn-005" fill="none" xmlns="http://www.w3.org/2000/svg"><circle cx="24" cy="24.8306" r="24" fill="#001A71"></circle><path d="M28.9401 18.7106L27.0601 16.8306L19.0601 24.8306L27.0601 32.8306L28.9401 30.9506L22.8334 24.8306L28.9401 18.7106Z" fill="#ffffff"></path></svg></div>
