            ...
            response.map((ele: any, index: number) => {
              return (
                <button
                  ...
                  data-te-slide-to="0"
                  data-te-carousel-active
                  className="mx-[3px] box-content lg:w-4 xl:w-4 lg:h-4 xl:h-4 w-2 h-2 flex-initial cursor-pointer border-0 border-transparent rounded-full bg-[#CCD1E3] bg-clip-padding p-0 -indent-[999px] transition-opacity duration-[600ms] ease-[cubic-bezier(0.25,0.1,0.25,1.0)] motion-reduce:transition-none"
                  aria-current="true"
                  aria-label="Slide 1"
                ></button>
              );
