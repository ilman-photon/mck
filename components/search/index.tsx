...
export default function Search() {
  ...
  return (
    <>
        ...
        <input type="text" className="input-search  outline-0 h-12 w-12 border-none px-3 py-4 pr-10 bg-transparent  absolute inset-y-0 right-3.5 blue-txt focus:w-80 focus:rounded-none focus:bg-white focus:top-1   " placeholder="Search..." />
 
 

        <svg className="search-icon absolute top-4 right-6 " width="18" height="19" viewBox="0 0 18 19" xmlns="http://www.w3.org/2000/svg">
