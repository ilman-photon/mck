          ...
          {relatedArticle?.map((item: any, index: any) => {
            return (
              <SwiperSlide
                ...
                id={`blog-detail-Slider-container`}
                    ...
                    <div>
                      <div className="content lg:p-6 p-4 lg:pt-4">
                        ...
                        <div className="pb-3 pt-3">
                          <span
                          id={`blog-detail-publish-time-${index}`} 
                          ...
                          <span
                              id={`blog-detail-readMinute-${index}`} 
