...
describe("CategoryComponent - Display values from CMS", () => {
  ...
  test("Render learning compontent", async () => {
    ...
    expect(
      screen.getByText(
        "You can find us at your local independently owned Health Mart pharmacies. Check back often to find out where you can find us next!"
      )
    ).toBeInTheDocument();
  });
});
...
const sectionData = [
  {
    ...
    contentType: ["Block", "TwoCloumnBlock"],
    parentLink: {
      id: 25,
      workId: 0,
    ...
    description: {
      value:
        "<p>You can find us at your local independently owned Health Mart pharmacies. Check back often to find out where you can find us next!</p>",
  ...
  },
  {
    ...
    description: {
      value:
        "<p>We offer product and a promise: quality products you can trust, and the guidance and care of a healthcare leader.</p>",
      propertyDataType: "PropertyXhtmlString",
    },
    image: {
      expandedValue: {
  ...
  },
  {
    ...
    description: {
      value:
        "<p>We make our products with high quality ingredients. Because when you start with what&rsquo;s good, you begin to get better.</p>",
      propertyDataType: "PropertyXhtmlString",
    },
    image: {
      expandedValue: {
    ...
    video: {
      expandedValue: {
        ...
        existingLanguages: [],
        masterLanguage: null,
        contentType: ["Video", "Media", "VideoFile"],
        parentLink: {
          id: 89,
          workId: 0,
  ...
  },
  {
    ...
    description: {
      value:
        "<p>We know that care can take many forms. We&rsquo;ve considered care from all angles, so that you can make sure you care for yourself in the best possible way. Your health is your business, and helping you be your best is ours.</p>",
      propertyDataType: "PropertyXhtmlString",
    },
    image: {
      expandedValue: {
